...
serve(async (req: Request): Promise<Response> => {
  ...
  try {
    ...
    const origin = redirectUrl || req.headers.get("origin") || "https://metrikapro.com.br";
      ...
      html: `
        ...
        <body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif; background-color: #f4f4f5; margin: 0; padding: 20px;">
          <div style="max-width: 480px; margin: 0 auto; background-color: #ffffff; border-radius: 12px; padding: 40px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
            ...
            <h2 style="color: #18181b; font-size: 20px; font-weight: 600; margin: 0 0 16px 0; text-align: center;">Recuperação de Senha</h2>
